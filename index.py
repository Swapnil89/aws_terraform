...
def create_message(dataset_id, revision_id):
    ...
    # assets_details = assets_details['Assets']
    # print('Assets: {}'.format(assets_details))
    # print('Asset_list: {}'.format(assets_details['Assets']))
    message = {
        'dataset_id' : dataset_id,
        'revision_id': revision_id,
        "location": "adx/export/" + dataset_id + "/" + revision_id
    }
